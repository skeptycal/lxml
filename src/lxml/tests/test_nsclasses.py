...
class ETreeNamespaceClassesTestCase(HelperTestCase):
    ...
    def test_ns_classes(self):
        ...
        tree = self.parse(
            _bytes(
                '<bluff xmlns="ns10"><ns11:maeh xmlns:ns11="ns11"/></bluff>'
            )
        )
    ...
    def test_default_tagname(self):
        bluff_dict = {None: self.bluff_class, "maeh": self.maeh_class}
    ...
    def test_element_creation(self):
        ...
        self.assertEqual("{http://a.b/c}HONK", el[0][0].tag)
        self.assertEqual("maeh_class", el[0][1].tag)
        ...
        self.assertEqual("TeXTTAiL", "".join(el[1].itertext()))
...
def test_suite():
    ...
    suite.addTests([make_doctest("../../../doc/element_classes.txt")])
    return suite
