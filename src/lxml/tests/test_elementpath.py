...
class EtreeElementPathTestCase(HelperTestCase):
    ...
    def _assert_tokens(self, tokens, path, namespaces=None):
        self.assertEqual(
            tokens, list(self._elementpath.xpath_tokenizer(path, namespaces))
        )
    ...
    def test_find(self):
        ...
        self.assertEqual(etree.ElementTree(elem).find("tag").tag, "tag")
        self.assertEqual(elem.find("section/tag").tag, "tag")
        self.assertEqual(
            etree.ElementTree(elem).find("section/tag").tag, "tag"
        )

        self.assertEqual(elem.findtext("tag"), "text")
        self.assertEqual(elem.findtext("tog"), None)
        self.assertEqual(elem.findtext("tog", "default"), "default")
        self.assertEqual(etree.ElementTree(elem).findtext("tag"), "text")
        self.assertEqual(elem.findtext("section/tag"), "subtext")
        self.assertEqual(
            etree.ElementTree(elem).findtext("section/tag"), "subtext"
        )

        self.assertEqual(summarize_list(elem.findall("tag")), ["tag", "tag"])
        self.assertEqual(
            summarize_list(elem.findall("*")), ["tag", "tag", "section"]
        )
        self.assertEqual(
            summarize_list(elem.findall(".//tag")), ["tag", "tag", "tag"]
        )
        self.assertEqual(summarize_list(elem.findall("section/tag")), ["tag"])
        self.assertEqual(summarize_list(elem.findall("section//tag")), ["tag"])
        ...
        self.assertEqual(summarize_list(elem.findall("*//*")), ["tag"])
        self.assertEqual(summarize_list(elem.findall("*/tag")), ["tag"])
        self.assertEqual(summarize_list(elem.findall("*/./tag")), ["tag"])
        self.assertEqual(summarize_list(elem.findall("./tag")), ["tag", "tag"])
        self.assertEqual(
            summarize_list(elem.findall(".//tag")), ["tag", "tag", "tag"]
        ...
        self.assertEqual(
            summarize_list(elem.findall("././tag")), ["tag", "tag"]
        )
        ...
        self.assertEqual(
            summarize_list(elem.findall(".//tag[@class='a']")), ["tag"]
        )
        self.assertEqual(
            summarize_list(elem.findall('.//tag[@class="a"]')), ["tag"]
        )
        self.assertEqual(
            summarize_list(elem.findall(".//tag[@class='b']")), ["tag", "tag"]
        )
        self.assertEqual(
            summarize_list(elem.findall('.//tag[@class="b"]')), ["tag", "tag"]
        )
        ...
        self.assertEqual(summarize_list(elem.findall(".//tag[@id]")), ["tag"])
        self.assertEqual(
            summarize_list(elem.findall(".//tag[@class][@id]")), ["tag"]
        )
        self.assertEqual(
            summarize_list(elem.findall(".//section[tag]")), ["section"]
        )
        self.assertEqual(
        ...
        self.assertEqual(
            summarize_list(elem.findall(".//section[tag='subtext']")),
            ["section"],
        )
        self.assertEqual(
            summarize_list(elem.findall(".//section[tag ='subtext']")),
        ...
        self.assertEqual(
            summarize_list(
                elem.findall(".//section[  tag   =   'subtext'  ]")
            ),
            ["section"],
        )
        self.assertEqual(
            summarize_list(elem.findall(".//tag[.='subtext']")), ["tag"]
        )
        self.assertEqual(
            summarize_list(elem.findall(".//tag[. ='subtext']")), ["tag"]
        )
        ...
        self.assertEqual(
            summarize_list(elem.findall(".//tag[. = 'subtext ']")), []
        )
        self.assertEqual(
            summarize_list(elem.findall(".//tag[.= ' subtext']")), []
        )
        ...
        self.assertEqual(summarize_list(elem.findall("../tag")), [])
        self.assertEqual(
            summarize_list(elem.findall("section/../tag")), ["tag", "tag"]
        )
        self.assertEqual(
            summarize_list(etree.ElementTree(elem).findall("./tag")),
            ["tag", "tag"],
        )
        ...
        self.assertEqual(
            summarize_list(elem.findall(".//tag[@class][@id]")), ["tag", "tag"]
        )
