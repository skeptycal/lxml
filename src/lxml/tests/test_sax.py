...
class ETreeSaxTestCase(HelperTestCase):
    ...
    def test_sax_to_pulldom(self):
        ...
        self.assertEqual(None, dom.firstChild.prefix)
    ...
    def test_sax_to_pulldom_multiple_namespaces(self):
        ...
        self.assertEqual("a", dom.firstChild.localName)
        self.assertEqual("blaA", dom.firstChild.namespaceURI)
        self.assertEqual("a", dom.firstChild.prefix)
    ...
    def test_element_sax(self):
        ...
        self.assertEqual(_bytes("<a><b/></a>"), xml_out)

        xml_out = self._saxify_serialize(b)
        self.assertEqual(_bytes("<b/>"), xml_out)
...
class NSPrefixSaxTestCase(HelperTestCase):
    ...
    def test_element_sax_default_ns_prefix(self):
        ...
        tree = self.parse(
            '<a xmlns="bla" xmlns:a="bla">' '<b a:attr="value" /></a>'
        )
        a = tree.getroot()
    ...
    def test_element_sax_twin_ns_prefix(self):
        ...
        tree = self.parse(
            '<a xmlns:b="bla" xmlns:c="bla">' '<d c:attr="attr" /></a>'
        )
        a = tree.getroot()
...
def test_suite():
    ...
    suite.addTests([make_doctest("../../../doc/sax.txt")])
    return suite
